CLASS zcx_bm_failed DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF carrier_not_exist,
        msgid TYPE symsgid VALUE 'ZBM_MESSAGES',
    ...
    CLASS-DATA carrier_id TYPE /dmo/carrier_id READ-ONLY.
...
CLASS zcx_bm_failed IMPLEMENTATION.
