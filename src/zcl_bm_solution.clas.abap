CLASS zcl_bm_solution DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_bm_solution IMPLEMENTATION.
...
*  DATA test TYPE i.
    ...
    IF carrier IS BOUND.
      ...
      out->write( 'Found a suitable passenger flight in hellopp'(001) ).
      out->write(  '------------------------------'(hau) ).
...
*      DATA(today) = CONV /dmo/flight_date( '20000101' ).
...
*
    ...
    DATA(date) = utclong_current( ).
    DATA string_int TYPE i.
    string_int = numofchar( 'ADFGHJ' ).
